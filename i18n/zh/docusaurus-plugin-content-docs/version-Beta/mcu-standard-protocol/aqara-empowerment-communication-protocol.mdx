# Aqara Empowerment Communication Protocol 规范
...
- 低功耗设备的串口唤醒机制、上电启动与初始化发现流程（参见 [第四章](#第四章-wake-and-initialization)）
- Profile 体系、应答与重传等实现规则（参见 [第五章](#第五章-profile-体系与实现规则)）
- Foundation Profile 与产品 Profile 的属性、命令定义（参见 [第六章](#第六章-foundation-profileprofile-id--0x0000) 和 [第七章](#第七章-product-profileprofile-id-0x1000)）
...
![AECP 系统架构](https://itad-aqara-docs-1300889962.aqara.com/dev/img/mcu-standard-protocol/zh/system_architecture.png)
...
| 层次 | 职责 | 本规范对应 |
|:---|:---|:---|
| 物理层 | UART 电气与时序、低功耗唤醒信号 | [第二章](#第二章-硬件接口)、[第四章](#第四章-wake-and-initialization) |
| 帧层 | 帧结构、字段编码、字节序、HCS 与 CRC 校验 | [第三章](#第三章-数据类型与交互格式) |
| 事务层 | 操作码语义、请求与应答配对、Seq 关联、超时与重传 | [第三章](#第三章-数据类型与交互格式)、[第五章](#第五章-profile-体系与实现规则) |
| 应用层 | 属性、命令、Profile 与 OTA 子协议 | [第五章](#第五章-profile-体系与实现规则)、[第六章](#第六章-foundation-profileprofile-id-0x0000)、[第七章](#第七章-product-profileprofile-id-0x1000) |
...
![AECP 应用交互模型](https://itad-aqara-docs-1300889962.aqara.com/dev/img/mcu-standard-protocol/zh/interaction_model.png)
...
![唤醒时序图](https://itad-aqara-docs-1300889962.aqara.com/dev/img/mcu-standard-protocol/zh/wake_timing.png)
...
![Wake and Initialization 启动流程](https://itad-aqara-docs-1300889962.aqara.com/dev/img/mcu-standard-protocol/zh/initialization_sequence.png)
...
![IAP OTA 升级流程](https://itad-aqara-docs-1300889962.aqara.com/dev/img/mcu-standard-protocol/zh/iap_ota_sequence.png)
...
![BootLoader OTA 升级流程](https://itad-aqara-docs-1300889962.aqara.com/dev/img/mcu-standard-protocol/zh/bootloader_ota_sequence.png)
...
所有实现 Thermostat Profile 的设备同时 SHALL 实现 [Foundation Profile（0x0000）](#foundation-profileprofile-id--0x0000) 中定义的全部属性与命令。
