---
title: "核心概念"
description: "Aqara Spec 物模型采用分层架构，从上到下依次为：Device(设备) → Endpoint(端点) → Device Type(设备类型) → Function(功能) → Trait(功能点) / Command(命令)。"
keywords: ["Aqara 文档", "Aqara Developer", "Aqara 数据模型规范", "核心概念", "core concepts"]
---
# 核心概念
