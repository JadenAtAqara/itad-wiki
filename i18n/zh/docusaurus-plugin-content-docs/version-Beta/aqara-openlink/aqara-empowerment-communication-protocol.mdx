...
| ID | 名称 | 类型 | 约束 | 默认值 | 访问权限 | 归属方 | 必选性 | 简述 |
|:---:|:---|:---|:---|:---:|:---:|:---:|:---:|:---|
| 0x1000 | [SystemMode](#systemmode-属性) | [ThermostatSystemModeEnum8](#thermostatsystemmodeenum8-类型) | 见枚举 | 0x00 | R/W/RP | S | M | 基础工作模式。 |
| 0x1001 | [OccupiedHeatingSetpoint](#occupiedheatingsetpoint-属性) | int16 | 设备能力范围 | — | R/W/RP | S | M | 设定制热温度。 |
| 0x1002 | [LocalTemperature](#localtemperature-属性) | int16 | 0.01℃ | — | R/RP | S | M | 设备环境温度测量值。 |
| 0x1003 | [LocalTemperatureCalibration](#localtemperaturecalibration-属性) | int8 | 0.1℃ | 0 | R/W/RP | S | M | 本地温度校准。 |
| 0x1004 | [KeypadLockout](#keypadlockout-属性) | [KeypadLockoutEnum8](#keypadlockoutenum8-类型) | 见枚举 | 0x00 | R/W/RP | S | O | 童锁状态。 |
| 0x1005 | [TemperatureDisplayMode](#temperaturedisplaymode-属性) | [TemperatureDisplayModeEnum8](#temperaturedisplaymodeenum8-类型) | 见枚举 | 0x00 | R/W/RP | S | O | 温度显示单位。 |
| 0x1006 | [FrostProtectionEnabled](#frostprotectionenabled-属性) | bool | true / false | false | R/W/RP | S | O | 防冻模式使能开关。 |
| 0x1007 | [FrostProtectionTemperature](#frostprotectiontemperature-属性) | int16 | Min ~ Max，0.01℃ | 500 | R/W/RP | S | O | 防冻模式触发温度。 |
| 0x1008 | [WindowDetectionEnabled](#windowdetectionenabled-属性) | bool | true / false | false | R/W/RP | S | O | 开窗检测功能使能开关。 |
| 0x100A | [ActivePower](#activepower-属性) | uint32 | mW | — | RP | S | O | 当前功率。 |
| 0x100B | [OpenWindowAlarm](#openwindowalarm-属性) | [OpenWindowAlarmEnum8](#openwindowalarmenum8-类型) | 见枚举 | 0x00 | R/RP | S | O | 当前开窗告警状态。 |
| 0x100C | [OpenWindowTemperatureControlPauseDuration](#openwindowtemperaturecontrolpauseduration-属性) | uint16 | Min ~ Max，min | 30 | R/W/RP | S | O | 开窗告警触发后暂停主动温控输出的时长。 |
| 0x100D | [OpenWindowTemperatureControlPauseDurationMin](#openwindowtemperaturecontrolpausedurationmin-属性) | uint16 | min | 1 | R/RP | S | O | 暂停时长下限。 |
| 0x100E | [OpenWindowTemperatureControlPauseDurationMax](#openwindowtemperaturecontrolpausedurationmax-属性) | uint16 | min | 1440 | R/RP | S | O | 暂停时长上限。 |
| 0x100F | [FrostProtectionAlarm](#frostprotectionalarm-属性) | [FrostProtectionAlarmEnum8](#frostprotectionalarmenum8-类型) | 见枚举 | 0x00 | R/RP | S | O | 当前防冻告警状态。 |
| 0x1010 | [FrostProtectionTemperatureMin](#frostprotectiontemperaturemin-属性) | int16 | 0.01℃ | 500 | R/RP | S | O | 防冻触发温度下限。 |
| 0x1011 | [FrostProtectionTemperatureMax](#frostprotectiontemperaturemax-属性) | int16 | 0.01℃ | 1500 | R/RP | S | O | 防冻触发温度上限。 |
| 0xFFFB | [ServerAttributeList](#serverattributelist-属性) | list[uint16] | 无额外约束 | — | R/RP | S | M | Server 支持的属性列表。 |
...
`OpenWindowTemperatureControlPauseDurationMin` 表示 `OpenWindowTemperatureControlPauseDuration` 支持的最小值，单位为分钟。

#### OpenWindowTemperatureControlPauseDurationMax 属性

`OpenWindowTemperatureControlPauseDurationMax` 表示 `OpenWindowTemperatureControlPauseDuration` 支持的最大值，单位为分钟。
...
`FrostProtectionTemperatureMin` 表示 `FrostProtectionTemperature` 支持的最小值，单位为 0.01℃。

#### FrostProtectionTemperatureMax 属性

`FrostProtectionTemperatureMax` 表示 `FrostProtectionTemperature` 支持的最大值，单位为 0.01℃。
...
| ID      | 名称                      | 方向               | 应答                   | 必选性 | 简述                       |
|---------|---------------------------|--------------------|------------------------|--------|----------------------------|
| 0x1000  | [ClearOpenWindowAlarmReq](#clearopenwindowalarmreq-命令)   | Client → Server    | [ClearOpenWindowAlarmRsp](#clearopenwindowalarmrsp-命令)| O      | 清除当前开窗告警并立即恢复温控。 |
| 0x1001  | [ClearOpenWindowAlarmRsp](#clearopenwindowalarmrsp-命令)   | Server → Client    | N                      | O      | 返回清除操作结果。          |
