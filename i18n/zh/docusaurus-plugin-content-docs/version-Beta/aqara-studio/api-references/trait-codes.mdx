...
| CurrentG | 绿色值 | number |  | ✔ | ✔ | ✔ |
| CurrentB | 蓝色值 | number |  | ✔ | ✔ | ✔ |
| [SupportedEndpointDynamic](./trait-details.mdx#supportedendpointdynamic-和-endpointarraydynamic) | 支持动态模式 |	boolean | | ✔ | ✘ | ✔ |
| [EndpointArrayDynamic](./trait-details.mdx#supportedendpointdynamic-和-endpointarraydynamic) | 节点动态数组 | other |  | ✔ | ✘ | ✔ |
| Feed | 喂食 | enum |  | ✔ | ✘ | ✔ |
