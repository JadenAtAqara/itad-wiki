...
| [查询空间列表](./space-management-api.mdx#查询空间列表) | GetSpacesRequest | GetSpacesResponse |
| [创建一个空间](./space-management-api.mdx#创建一个空间) | CreateSpaceRequest | CreateSpaceResponse |
| [编辑空间](./space-management-api.mdx#编辑空间) | UpdateSpaceRequest | UpdateSpaceResponse |
| [关联设备到空间](./space-management-api.mdx#关联设备到空间) | AssociateDevicesToSpaceRequest | AssociateDevicesToSpaceResponse |
