...
| data.data[].space | Object | 设备关联的空间信息。具体结构请参考 [Space 结构](./space-management-api.mdx#space-结构)。 |
...
| data[].space | Object | 设备关联的空间信息。具体结构请参考 [Space 结构](./space-management-api.mdx#space-结构)。 |
