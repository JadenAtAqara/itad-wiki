...
3. 选择 `KNX IP`，切换至 **添加设备** 选项卡，在填写如下参数，保存并继续。   
    ![添加 KNX 设备](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/zh/KNX-AddADevice.png)   
    相关字段如下表所示：   
    <table>
      <thead>
        <tr>
...
4. **点击上传**设备对应的 KNXPROJ 文件或群组地址 XML 文件（均可通过 ETS6 导出）。   
  ![上传文件](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/zh/KNX-UploadFile.png)

5. 文件上传成功后，点击 **发现功能点** 按钮，系统将自动解析文件并生成可添加的点位列表。

  ![发现功能点](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/zh/KNX-DiscoverPoints.png)

6. 勾选需要的点，单击中间 **+** 按钮，新增功能点会出现在右侧的**已添加功能点**列表，并同步显示在左侧设备树的相关设备下。
    ...
    ![修改功能点类型](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/zh/KNX-ModifyTrait.png)
    :::
