...
3. （可选）切换至“添加设备”单选项卡，单击 ⚙ 按钮，即可设置设备发现规则。
...
5. 选择需接入的设备后，点击中间“+”按钮，新增设备会出现在右侧的**已添加设备列表**，并同步显示在左侧设备树的 BACnet IP 下。

6. 在设备树选择您新增的设备，进入设备配置页面。在`功能点`选项卡单击`添加功能点`按钮。在“添加功能点”页面，单击 **发现功能点** 按钮，Aqara Studio 即开始扫描发现该设备的功能点。 

    :::tip
    如果本系统没有发现你需要的功能点，您也可以 [手动添加该功能点](#如何处理-aqara-studio-无法发现-bacnet-功能点的问题)。
    :::

7. 勾选需要的点，单击中间 **+** 按钮，新增功能点会出现在右侧的**已添加功能点**列表，并同步显示在左侧设备树的相关设备下。
