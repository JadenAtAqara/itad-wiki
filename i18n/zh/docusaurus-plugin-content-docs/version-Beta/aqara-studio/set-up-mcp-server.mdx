---
title: "连接至 Aqara Studio MCP Server"
description: "本文介绍如何连接至 Aqara Studio MCP Server。"
keywords: ["Aqara 文档", "Aqara Studio", "连接至 Aqara Studio MCP Server", "set up mcp server"]
---
...
请参考 [开发者指南 - 获取必要信息](./developer-guide.mdx#获取-token)，获取授权 Token，用于通过用户身份验证，以便与 Aqara Studio MCP Server 建立连接。
