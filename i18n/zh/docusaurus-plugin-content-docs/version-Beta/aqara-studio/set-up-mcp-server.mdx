...
- 请注意，根据 OpenAI 官方文档[Developer mode, and MCP apps in ChatGPT【beta】 - Availability and requirements](https://help.openai.com/en/articles/12584461-developer-mode-and-mcp-apps-in-chatgpt-beta)，Apps、完整的 MCP 支持及开发者模式目前仅面向 ChatGPT Web 的 **Business** 和 **Enterprise/Edu** 用户开放。因此，在使用 MCP 服务前，请务必确认您的 ChatGPT 用户套餐已达到要求。
:::
