...
:::tip
OpenAI 官方文档：
- 通过 MCP 创建 App：[ChatGPT Developer Mode - How to Use](https://platform.openai.com/docs/guides/developer-mode#how-to-use)
- [Developer mode, and MCP apps in ChatGPT【beta】 - 可用性与要求](https://help.openai.com/en/articles/12584461-developer-mode-and-mcp-apps-in-chatgpt-beta)
:::
...
5. 在 **OAuth 授权确认页** 点击 **同意**，即可激活 MCP App，授权有效期为 7 天。
    ...
    ![填写 Token](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/zh/MCP-ChatGPT5.png)
