---
title: "Core Concepts"
description: "The Aqara Spec data model uses a layered architecture, from top to bottom: Device(Device) → Endpoint(Endpoint) → Device Type(Device Type) → Function(Function) → Trait(Trait) / Command(Command)."
keywords: ["Aqara Docs", "Aqara Developer", "Aqara Data Model Specification", "Core Concepts"]
---
# Core Concepts
