...
| ID | Name | Type | Constraint | Default | Access | Side | Conformance | Description |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x1000 | [SystemMode](#systemmode) | [ThermostatSystemModeEnum8](#thermostatsystemmodeenum8) | See enum | 0x00 | R/W/RP | S | M | basic operating mode. |
| 0x1001 | [OccupiedHeatingSetpoint](#occupiedheatingsetpoint) | int16 | Device capability range | - | R/W/RP | S | M | heating setpoint. |
| 0x1002 | [LocalTemperature](#localtemperature) | int16 | 0.01degC | - | R/RP | S | M | measured ambient temperature. |
| 0x1003 | [LocalTemperatureCalibration](#localtemperaturecalibration) | int8 | 0.1degC | 0 | R/W/RP | S | M | local temperature calibration. |
| 0x1004 | [KeypadLockout](#keypadlockout) | [KeypadLockoutEnum8](#keypadlockoutenum8) | See enum | 0x00 | R/W/RP | S | O | keypad lockout state. |
| 0x1005 | [TemperatureDisplayMode](#temperaturedisplaymode) | [TemperatureDisplayModeEnum8](#temperaturedisplaymodeenum8) | See enum | 0x00 | R/W/RP | S | O | temperature display unit. |
| 0x1006 | [FrostProtectionEnabled](#frostprotectionenabled) | bool | true / false | false | R/W/RP | S | O | frost-protection enable switch. |
| 0x1007 | [FrostProtectionTemperature](#frostprotectiontemperature) | int16 | Min ~ Max, 0.01degC | 500 | R/W/RP | S | O | frost-protection trigger temperature. |
| 0x1008 | [WindowDetectionEnabled](#windowdetectionenabled) | bool | true / false | false | R/W/RP | S | O | open-window detection enable switch. |
| 0x1009 | [ActiveCurrent](#activecurrent) | uint32 | mA | - | RP | S | O | current. |
| 0x100A | [ActivePower](#activepower) | uint32 | mW | - | RP | S | O | current power. |
| 0x100B | [OpenWindowAlarm](#openwindowalarm) | [OpenWindowAlarmEnum8](#openwindowalarmenum8) | See enum | 0x00 | R/RP | S | O | current open-window alarm state. |
| 0x100C | [OpenWindowTemperatureControlPauseDuration](#openwindowtemperaturecontrolpauseduration) | uint16 | Min ~ Max, min | 30 | R/W/RP | S | O | duration for which active temperature-control output is suspended after an open-window alarm. |
| 0x100D | [OpenWindowTemperatureControlPauseDurationMin](#openwindowtemperaturecontrolpausedurationmin) | uint16 | min | 1 | R/RP | S | O | minimum pause duration. |
| 0x100E | [OpenWindowTemperatureControlPauseDurationMax](#openwindowtemperaturecontrolpausedurationmax) | uint16 | min | 1440 | R/RP | S | O | maximum pause duration. |
| 0x100F | [FrostProtectionAlarm](#frostprotectionalarm) | [FrostProtectionAlarmEnum8](#frostprotectionalarmenum8) | See enum | 0x00 | R/RP | S | O | current frost-protection alarm state. |
| 0x1010 | [FrostProtectionTemperatureMin](#frostprotectiontemperaturemin) | int16 | 0.01degC | 500 | R/RP | S | O | minimum frost-protection temperature. |
| 0x1011 | [FrostProtectionTemperatureMax](#frostprotectiontemperaturemax) | int16 | 0.01degC | 1500 | R/RP | S | O | maximum frost-protection temperature. |
| 0xFFFB | [ServerAttributeList](#serverattributelist) | list[uint16] | No additional constraints | - | R/RP | S | M | list of attributes supported by Server. |
...
`OpenWindowTemperatureControlPauseDurationMin` indicates the minimum value supported for `OpenWindowTemperatureControlPauseDuration`, in minutes.

#### OpenWindowTemperatureControlPauseDurationMax

`OpenWindowTemperatureControlPauseDurationMax` indicates the maximum value supported for `OpenWindowTemperatureControlPauseDuration`, in minutes.
...
`FrostProtectionTemperatureMin` indicates the minimum value supported for `FrostProtectionTemperature`, in units of 0.01degC.

#### FrostProtectionTemperatureMax

`FrostProtectionTemperatureMax` indicates the maximum value supported for `FrostProtectionTemperature`, in units of 0.01degC.
...
| ID      | Name                      | Direction         | Response               | Conformance | Description                                                                      |
|---------|---------------------------|-------------------|------------------------|-------------|----------------------------------------------------------------------------------|
| 0x1000  | [ClearOpenWindowAlarmReq](#clearopenwindowalarmreq)   | Client → Server   | [ClearOpenWindowAlarmRsp](#clearopenwindowalarmrsp)| O           | Clear the active open-window alarm and immediately resume temperature control.    |
| 0x1001  | [ClearOpenWindowAlarmRsp](#clearopenwindowalarmrsp)   | Server → Client   | N                      | O           | Return the result of the clear operation.                                         |
