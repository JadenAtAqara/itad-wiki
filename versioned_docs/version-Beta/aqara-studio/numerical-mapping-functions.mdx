...
| --- | --- | --- | --- | --- |
| Utility | Linear Mapping | linear(x, inMin, inMax, outMin, outMax) | Linearly maps the input value from the original range to the target range. | Map ADC raw value (0~1023) to temperature (-40~125°C): `linear(source.value, 0, 1023, -40, 125)` |
