---
title: "Numerical Mapping Functions"
description: "Lists all numerical mapping functions available for protocol device integration, with syntax and parameters explained."
keywords: ["Aqara Docs", "Aqara Studio", "Numerical Mapping Functions"]
---
