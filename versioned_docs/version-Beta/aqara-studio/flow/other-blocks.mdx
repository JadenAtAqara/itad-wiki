...
|-----------------------------|:--:|-------------|
| Count Up (Input Point)      | ✘ | It connects to an [Event](./../flow/device-blocks.mdx#event) or a [Condition](./device-blocks.mdx#condition) card. Each time the event or condition occurs, the count increases. |
| Count Down (Input Point)    | ✘ | It connects to an [Event](./../flow/device-blocks.mdx#event) or a [Condition](./device-blocks.mdx#condition) card. Each time the event or condition occurs, the count decreases. |
| Preset (Input Point)        | ✘ | It connects to an [Event](./../flow/device-blocks.mdx#event) or a [Condition](./device-blocks.mdx#condition) card. Each time the event or condition occurs, the count is reset to the preset value. |
| Clear (Input Point)         | ✘ | It connects to an [Event](./../flow/device-blocks.mdx#event) or a [Condition](./device-blocks.mdx#condition) card. Each time the event or condition occurs, the count is cleared (set to zero). |
