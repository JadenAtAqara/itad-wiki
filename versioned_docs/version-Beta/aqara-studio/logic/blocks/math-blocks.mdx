---
title: "Math Blocks"
description: "Math blocks enable a variety of mathematical operations for processing numeric data in automation workflows, supporting tasks like calculations, data transformation, threshold checks, and more."
keywords: ["Aqara Docs", "Aqara Studio", "Logic", "Math Blocks"]
---
# Math Blocks
