...
description: "Variable logic blocks are used to define, store, and transfer data in automation flows. They are the foundation for building flexible and complex logic."
keywords: ["Aqara Docs", "Aqara Studio", "Logic", "Variables Blocks"]
---
# Variables Blocks
