---
title: "Logic Blocks"
description: "Logic blocks help you create powerful automations by evaluating multiple conditions together. Use them to make decisions based on 'And', 'Or', 'Xor', 'Equal', comparison operations, and more."
keywords: ["Aqara Docs", "Aqara Studio", "Logic", "Logic Blocks"]
---
# Logic Blocks
