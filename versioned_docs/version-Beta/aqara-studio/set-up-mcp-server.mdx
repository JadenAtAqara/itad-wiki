---
title: "Connect to Aqara Studio MCP Server"
description: "MCP is an open protocol for simple, unified AI connectivity with external systems."
keywords: ["Aqara Docs", "Aqara Studio", "Connect to Aqara Studio MCP Server"]
---
