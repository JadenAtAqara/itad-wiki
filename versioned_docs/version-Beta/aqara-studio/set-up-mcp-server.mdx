...
4. On the **OAuth login page**, enter your [token](./set-up-mcp-server.mdx#get-your-token).

    ![Fill in token](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/zh/MCP-ChatGPT4.png)

5. On the **OAuth confirmation page**, click **Agree** to activate your MCP app.

    ![Agree to OAuth](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/zh/MCP-ChatGPT5.png)

    :::tip
    If you want to change the token, just click **Sign out** on this page and you'll return to the OAuth login page.
    :::
