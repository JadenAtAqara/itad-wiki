---
title: "Classic"
description: "This article guides you through creating Classic automation in Aqara Studio using the When-And-Then structure."
keywords: ["Aqara Docs", "Aqara Studio", "Classic"]
---
# Classic
...
To learn how to create an Classic automation, please refer to [Automation - Create an Automation](./automation.mdx#create-an-automation).

## Set Up Automation

See below for how to set up an Classic automation flow.
...
1. Click **Add Trigger**.<br/>
    <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-AddEvent.png" style={{width: '80%'}} />   

2. Choose **Device** or **Scheduled Trigger**.<br/>
    <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-EventTypes.png" style={{width: '80%'}} />   
...
- If you choose **Device**:
    1. Add a device event<br/>
        ...
        <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-DevicePopup.png" style={{width: '80%'}} />   
        Now, in the **When** section, you'll see Studio will monitor this device event and its default value **24/7**.   
        <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-EventAdded.png" style={{width: '80%'}} />   
    2. Edit the value<br/>
        If you'd like to listen for another value, click the blue text in the event to modify it.<br/>
        <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-ModifyEventParameter.png" style={{width: '80%'}} />   
        3. Add time constraints
            ...
            - Set effective listening period   
                ...
                <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SetEventTimePeriod.png" style={{width: '80%'}} />   
            - Set event duration requirement
                ...
                <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SetEventDuration.png" style={{width: '80%'}} />   
    - If you choose **Trigger Time**:
        1. Select which weekdays the action should run (multiple selections supported).
            <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SetEventDate.png" alt="Choose weekdays" style={{width: '80%'}} />   
        2. Set the type of time.
            <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SetTimeType.png" alt="Choose time type" style={{width: '80%'}} />   
            ...
            <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-PassInLongitudeandLatitude.png" alt="Enter latitude/longitude" style={{width: '80%'}} />

            ::: 

        3. Set the exact time.
            <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SpecifyTime.png" alt="Set specific time" style={{width: '80%'}} />   
...
<img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SelectEventLogic.png" alt="Set trigger logic" style={{width: '80%'}} />   
...
1. Click **Add Condition**.<br />
    <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-AddCondition.png" style={{width: '80%'}} />   
2. Choose **Device**.<br />
    <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-AddConditionDevice.png" style={{width: '80%'}} />   
3. Select the needed **device** and its **function card**, then click **Confirm**.<br />
    <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SelectConditionFunction.png" style={{width: '80%'}} />   
    After completion, you'll see the chosen device condition in the **And** section, showing its **default state**.<br />
    <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-ConditionAdded.png" style={{width: '80%'}} />    
4. Edit target values for condition
    ...
    <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-ModifyConditionParameter.png" style={{width: '80%'}} />   
...
<img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SelectConditionLogic.png" alt="Set condition logic" style={{width: '80%'}} />   
...
3. Select the needed **device** and its **function card**, then click **Confirm**.
    - If you choose **Device**:
        1. Add device action
            ...
            <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-ActionAdded.png" style={{width: '80%'}} />   
        2. Edit action parameters
            To adjust the action's parameters, click the blue field and select or input the target value.<br />
            <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-ModifyAction.png" style={{width: '80%'}} />   
    ...
    - If you choose **Delay**: Click the blue duration field to change the delay length.<br />
        <img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-DelayTimeSetting.png" style={{width: '80%'}} />   
...
<img src="https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Classic-SelectActionLogic.png" alt="Set action execution logic" style={{width: '80%'}} />   
...
Once you confirm your automation works as expected, click **Save**. The new Classic automation (enabled by default) will appear in the **Automation** page.