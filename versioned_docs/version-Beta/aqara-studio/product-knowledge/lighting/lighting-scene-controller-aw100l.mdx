...
The Lighting Scene Controller AW100L is the core control hub of Aqara's RS-485 scene lighting solution. It adopts industrial-grade RS-485 bus communication and requires use with [AX100M](./../gateways/din-rail-hub-ax100m.mdx). It can stably drive Pastel Light Board H1 (large board) and [Pastel Light Module H1](./pastel-light-module-h1.mdx) (small board) and other SPI-RGBW tinted color light sources.
...
* LED Protocol: Select SM5206E for Pastel Light Board H1; Select SM18635E for [Pastel Light Module H1](./pastel-light-module-h1.mdx)
...
Currently supports Pastel Light Board H1 (large board, ZCGSSGYB01LM) and [Pastel Light Module H1](./pastel-light-module-h1.mdx) (small board, ZCGSSGYMZ01LM) tinted color light sources.
