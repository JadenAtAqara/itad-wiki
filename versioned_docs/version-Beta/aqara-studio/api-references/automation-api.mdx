...
description: "By calling this API, you can obtain information about function points available for automation configuration from all devices. The returned content includes the value type and unit of each function point, as well as the applicable phase in the automation process (such as being used as a trigger, condition, or action)."
keywords: ["Aqara Docs", "Aqara Studio", "API Reference", "Automation API"]
---
# Automation API
