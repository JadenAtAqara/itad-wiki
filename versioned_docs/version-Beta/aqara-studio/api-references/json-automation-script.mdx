...
keywords: ["Aqara Docs", "Aqara Studio", "API Reference", "JSON Automation Script"]
---
...
Before you start writing a JSON automation script, please make sure you have obtained the necessary trait information by calling the `QueryDeviceSupportedScriptAutomationConfigRequest` API. For details, see [Query Device Traits Available for Automation](./automation-api.mdx#query-device-traits-available-for-automation).
