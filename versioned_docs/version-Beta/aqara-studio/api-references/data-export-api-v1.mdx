...
| [Query Space List](./space-management-api.mdx#query-space-list) | GetSpacesRequest | GetSpacesResponse |
| [Create A Space](./space-management-api.mdx#create-a-space) | CreateSpaceRequest | CreateSpaceResponse |
| [Update A Space](./space-management-api.mdx#update-a-space) | UpdateSpaceRequest | UpdateSpaceResponse |
| [Associate Devices with Space](./space-management-api.mdx#associate-devices-with-space) | AssociateDevicesToSpaceRequest | AssociateDevicesToSpaceResponse |
