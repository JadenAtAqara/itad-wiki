---
title: "Complex Trait Details"
description: "This document explains the meaning, determination process, and examples of multiple complex traits."
keywords: ["Aqara Docs", "Aqara Studio", "API Reference", "Complex Trait Details"]
---
