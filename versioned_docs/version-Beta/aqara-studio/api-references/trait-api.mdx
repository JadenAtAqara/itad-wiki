...
| data.data[].space | Object | Space information associated with the device. For the detailed structure, refer to [Space Structure](./space-management-api.mdx#space-structure). |
...
| data[].space | Object | Space information associated with the device. For the detailed structure, refer to [Space Structure](./space-management-api.mdx#space-structure). |
