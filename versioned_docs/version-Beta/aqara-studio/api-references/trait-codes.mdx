...
> For detailed definitions of each trait (including value ranges, enumeration explanations, etc.), please use the [GetDevicesRequest](./data-export-api-v1.mdx#查询设备的-spec-配置) API to get the full configuration information.
