---
title: "Trait Codes"
description: "This document summarizes all trait codes supported by Aqara devices."
keywords: ["Aqara Docs", "Aqara Studio", "API Reference", "Trait Codes"]
---
# Trait Codes
...
> For detailed definitions of each trait (including value ranges, enumeration explanations, etc.), please use the [GetDevicesRequest](./trait-api.mdx#query-device-spec-configuration) API to get the full configuration information.
