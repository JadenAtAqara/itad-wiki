    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>本机IP地址</td>
                <td>✘</td>
                <td>指定本机的IP地址，用于BACnet/IP 设备在 IP 网络中的地址；格式：xxx.xxx.xxx.xxx（如：192.168.1.100）；默认使用：0.0.0.0 表示系统自动分配。</td>
                <td>1</td>
            </tr>
            <tr>
                <td>设备实例号</td>
...
6. 在左侧侧边栏双击您新增的设备，进入设备配置页面。在`点发现`选项卡单击`发现`按钮。Aqara Studio 即开始扫描发现该设备的测点。 

    > **说明**
    >
    > 如果本系统没有发现你需要的测点，您也可以 [手动添加该测点](#如何处理-aqara-studio-无法发现-bacnet-测点的问题)。
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Aqara 对象类型</td>
                    <td>✘</td>
                    <td>Aqara 定义的测点对象类型。</td>
                </tr>
                <tr>
                    <td>对象类型</td>
                    <td>✘</td>
                    <td>BACnet 定义的测点对象类型。</td>
                </tr>
                <tr>
                    <td>对象实例号</td>
                    <td>✔</td>
                    <td>此测点的对象实例号。取值范围：[0, 4194303]。</td>
                </tr>
                <tr>
                    <td>描述</td>
                    <td>✘</td>
...
### 如何处理 Aqara Studio 无法发现 BACnet 测点的问题

若 Aqara Studio 未发现您需要的测点，请在“添加点”的页面单击“手动添加”，在“添加点”弹窗中传入点的各项参数，完成手动添加点。
...
| ---- | ------ | ---- |
| 点名称 | ✔ | 您可自定义此测点的名称。 |
| Aqara 对象类型 | ✘ | Aqara 定义的测点对象类型。 |
| 对象类型 | ✔ | BACnet 定义的测点对象类型。 |
| 对象实例号 | ✘ | 此测点的对象实例号。取值范围：[0, 4194303]。 |
| 描述 | ✘ | 描述 |
