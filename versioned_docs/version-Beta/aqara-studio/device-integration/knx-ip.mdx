...
2. In the device tree on the left, click the "+" button. In the popup, choose `KNX IP`.   
    ![Select KNX](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Devices-SelectKNX.png)


3. Click `KNX IP`, switch to the **Add Device** tab. fill in the following parameters, and then click the  **Save and continue** button.   
    ![Add a KNX device](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/KNX-AddADevice.png)   
...
4. **Upload** the KNXPROJ file or group address XML file for the device (both can be exported via ETS6).    
  ![Discover points](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/KNX-DiscoverPoints.png)
...
| Aqara Object Type| The device type this point belongs to. |