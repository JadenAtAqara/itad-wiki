...
1. In the left sidebar, click to enter the **Devices** page. In the device tree on the left, click the "+" button.

  ![Click the addition button](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/Devices-ClickAddButton.png)

2.  In the popup, select `Home Assistant` to add the `Home Assistant`.

  ![Select Home Assistant](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/SelectProtocol-HomeAssistant.png)

3. Select the `Home Assistant` folder to enter the Home Assistant management page.
4. Go to the **Protocol Configuration** tab. In "Basic Configuration", type in the local IP address, port, and the [token](#how-to-get-a-home-assistant-token) of your Home Assistant system.

  ![Configure the Protocol](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en99/HomeAssistant-ProtocolConfiguration.png)

5. Go to the `Add Device` tab and click the "Discover Devices" button. Aqara Studio will automatically find devices from your Home Assistant.

  ![Discover devices](https://itad-aqara-docs-1300889962.aqara.com/dev/img/aqara-studio/en/HomeAssistant-ClickDiscoverDevicesButton.png)

6. After selecting the devices you wish to add, click the "+" button in the center. The newly added devices will appear in the **Added Device List** on the right, and will also be visible under Home Assistant on the left device tree.
