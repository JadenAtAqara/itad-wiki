...
description: "Component categories include device, basic component, control, basic chart, table, media, and other."
keywords: ["Aqara Docs", "Aqara Studio", "Graph", "Component Categories"]
---
...
- The **Then** step in Classic automation ([details](./../classic-automation.mdx#3-configure-then))
